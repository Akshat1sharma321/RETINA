...
import { Info, RefreshCw, Settings, Download, AlertTriangle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:ml-64 pt-16 lg:pt-6 min-h-screen">
        <div className="container px-4 py-6">
          <div>
            <h2 className="text-2xl font-semibold text-white mb-1">About Device</h2>
            <p className="text-gray-400">
              View information and manage your NAVI smart glasses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            <Card className="border border-white/10 bg-black/40 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>Technical details about your NAVI device</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium font-mono">{deviceInfo.serialNumber}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-green-400">{deviceInfo.batteryHealth}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Last Maintenance</span>
                    <span className="font-medium">{deviceInfo.lastMaintenance}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="font-medium">{deviceInfo.storageUsed} GB of {deviceInfo.storageTotal} GB</span>
                    </div>
                    <Progress value={(deviceInfo.storageUsed / deviceInfo.storageTotal) * 100} className="h-2" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div className="space-y-1">
                      ...
                      <Progress value={(8.2 / deviceInfo.storageTotal) * 100} className="h-1.5 bg-gray-800" />
                    </div>
                    <div className="space-y-1">
                      <div className="flex justify-between">
                      ...
                      <Progress value={(3.6 / deviceInfo.storageTotal) * 100} className="h-1.5 bg-gray-800" />
                    </div>
                    <div className="space-y-1">
                      <div className="flex justify-between">
                      ...
                      <Progress value={(1.8 / deviceInfo.storageTotal) * 100} className="h-1.5 bg-gray-800" />
                    </div>
                    <div className="space-y-1">
                      <div className="flex justify-between">
                      ...
                      <Progress value={(0.9 / deviceInfo.storageTotal) * 100} className="h-1.5 bg-gray-800" />
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <Card className="border border-white/10 bg-black/40 backdrop-blur-sm">
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <p className="text-gray-400 mb-4 text-sm">
                  Ensure your device has the latest features and security updates
                </p>
                <Button onClick={checkForUpdates} className="w-full bg-navi-600 hover:bg-navi-700">
                  Check Now
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="border border-white/10 bg-black/40 backdrop-blur-sm">
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-medium mb-3">Reset Device Settings</h3>
                <p className="text-gray-400 mb-4 text-sm">
                  Restore default settings without deleting your data
                </p>
                <Button onClick={resetDevice} variant="outline" className="w-full">
                  Reset Settings
                </Button>
              </CardContent>
            </Card>
          ...
          <Card className="border border-white/10 bg-black/40 backdrop-blur-sm mt-6">
            <CardHeader>
              ...
              <CardDescription>Access guides and manuals for your device</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Complete guide to using NAVI smart glasses</p>
                    </div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Get started with your device in minutes</p>
                    </div>
                  </div>
                  <Button variant="outline" size="sm" className="gap-2">
                    <Download size={16} /> Download
                ...
                <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Solutions to common issues</p>
                    </div>
                  </div>
                  <Button variant="outline" size="sm" className="gap-2">
                    <Download size={16} /> Download
